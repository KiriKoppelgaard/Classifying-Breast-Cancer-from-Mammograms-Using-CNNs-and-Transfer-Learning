...
for base_model in base_models: 
  ...
  # unfreeze top 2 blocks so they can be fine-tuned during the remaining training
  if base_model == 'inceptionv3':
  ...
  model.compile(keras.optimizers.Adam(0.001), # low learning rate
...
#transfer learning and fine-tuning sources
