...
#  visualize layer names and layer indices to figure out (together with the plot_model png) how many layers we should freeze
# in order to freeze the top two blocks 
